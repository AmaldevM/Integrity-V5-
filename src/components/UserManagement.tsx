...
export const UserManagement: React.FC<UserManagementProps> = ({ onLoginAs }) => {
  ...
  if (editingUser) {
    return (
      <div className="bg-[#0F172A]/90 backdrop-blur-xl border border-slate-700/50 p-6 rounded-2xl shadow-2xl max-w-4xl mx-auto relative overflow-hidden">
        {/* Glow Effect */}
  ...
  // ----------------------------------------------------------------------
  return (
    <div className="bg-[#0F172A]/60 backdrop-blur-xl border border-slate-700/50 p-6 rounded-2xl shadow-2xl relative overflow-hidden">
                ...
                <td className="p-4">
                    <div className="flex flex-col items-start gap-1">
                        <span className={`px-2 py-0.5 rounded text-[10px] font-bold border ${
                            user.role === UserRole.ADMIN ? 'bg-purple-900/30 text-purple-300 border-purple-800' :
