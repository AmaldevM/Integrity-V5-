                      ...
                      <td className="p-4 text-slate-400 text-xs">
                        {isIssue ? (
                          ...
                          <div className="flex items-center gap-1.5">
                            ...
                            {/* Note: In a real app you'd fetch customer details here too */}
                            <span className="font-mono text-slate-300 bg-slate-800 px-1 rounded">{tx.toUserId ? tx.toUserId.split('-')[0] : 'Unknown'}...</span>
                          </div>
                        )}
                      </td>
                    </tr>
